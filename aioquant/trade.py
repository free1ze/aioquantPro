...
#     def __init__(self, strategy=None, symbol=None, host=None, wss=None, account=None, access_key=None,
#                  secret_key=None, passphrase=None, testnet=None, order_update_callback=None, position_update_callback=None,
